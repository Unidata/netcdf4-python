...
class Dataset:
    ...
    def createDimension(self, dimname: str, size: int | float | None = None) -> Dimension: ...
...
class Dimension:
    def __init__(self, grp: Dataset, name: str, size: int | float | None = None, **kwargs: Any) -> None: ...
    @property
    def name(self) -> str: ...
    @property
    def size(self) -> int: ...
