...
class CompressionTestCase(unittest.TestCase):
    ...
    def runTest(self):
        ...
        {'zlib':True,'zstd':False,'bzip2':False,'shuffle':False,'complevel':complevel,'fletcher32':False}
        ...
        assert_almost_equal(data_array,f.variables['data'][:])
        assert f.variables['data'].filters() ==\
        {'zlib':True,'zstd':False,'bzip2':False,'shuffle':True,'complevel':complevel,'fletcher32':False}
