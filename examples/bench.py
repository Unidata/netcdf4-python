...
def write_netcdf(filename,zlib=False,least_significant_digit=None):
...
t = Timer("write_netcdf('test2.nc',zlib=True,least_significant_digit=4)","from __main__ import write_netcdf")
