...
datacheck4 = ma.array([1.5678,99.99,3.75145,4.127654],mask=mask,dtype=np.float32)
fillval = _default_fillvals[datacheck4.dtype.str[1:]]
datacheck5 = np.array([1.5678,fillval,3.75145,4.127654],dtype=np.float32)
...
class PrimitiveTypesTestCase(unittest.TestCase):
    ...
    def runTest(self):
        ...
        # check that masked arrays are handled correctly when no
